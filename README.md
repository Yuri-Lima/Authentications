...
- Make sure your NodeJS and npm versions are up to date for `React 19`
...
- customize .env file.
  Here you can customize your MongoDB server URL.
  Yon can customize sendgrid api key and server.
